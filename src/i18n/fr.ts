...
const fr: LocaleBundle = {
  cv: {
    ...
    projects: [
      {
        name: 'EXSIX',
        blurb: 'Un sanctuaire web gothique pour EXSIX, collectif de musique et de mode : des shaders de brume en WebGL brut, des cadres ornementaux calqués sur leur propre art, et des rituels du web d\'antan (livre d\'or fonctionnel, compteur de visites honnête) construits avec Astro.',
        ...
        imageAlt: 'Le sigil d\'EXSIX, un monogramme XG hérissé dans un hexagramme, sur un fond de brume rouge ditherisée',
      },
      {
        name: 'La Casa',
  ...
  ui: {
    nav: { work: 'Parcours', approach: 'Approche', skills: 'Compétences', projects: 'Projets', contact: 'Contact', cv: 'CV', skipToContent: 'Aller au contenu', menu: 'Menu', editionAria: 'Changer d\'édition du design. Actuelle :', editionEditorial: 'Éditoriale', editionRiso: 'Impression riso', editionTerminal: 'Terminal', editionNudgeTitle: 'Un site, trois designs', editionNudgeBody: 'Ce bouton change tout le système de design instantanément.', editionNudgeCta: 'Montrez-moi la magie' },
    hero: {
