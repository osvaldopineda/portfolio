...
const es: LocaleBundle = {
  ...
  ui: {
    nav: { work: 'Experiencia', approach: 'Enfoque', skills: 'Skills', projects: 'Proyectos', contact: 'Contacto', cv: 'CV', skipToContent: 'Saltar al contenido', menu: 'Menú', editionAria: 'Cambiar edición de diseño. Actual:', editionEditorial: 'Editorial', editionRiso: 'Impresión riso', editionTerminal: 'Terminal', editionNudgeTitle: 'Un sitio, dos diseños', editionNudgeBody: 'Este botón cambia todo el sistema de diseño al instante.', editionNudgeCta: 'Quiero ver la magia' },
    hero: {
